...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
        <h2 class="h5 mb-4">ACTUALIZAR DATOS DEL ALUMNO<hr></h2>
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="tutor_principal" class="form-control" value="{{ $alumno->tutor_principal}}"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="colonia" class="form-control" value="{{ $alumno->colonia}}"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="telefono_contacto" class="form-control" value="{{ $alumno->telefono_contacto}}"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <label class="col-sm-12 col-form-label">Parentesco</label>
                    <div class="col-sm-12">
                      <input type="text" name="parentesco2" class="form-control" value="{{ $alumno->parentesco2}}"/>
                    </div>
                </div>

                <div class="col-md-4">
                    <label class="col-sm-12 col-form-label">Tel1. Autorizada</label>
                    <div class="col-sm-12">
                ...
                <a href="/alumno"  class="btn btn-primary btn-fw mb-3">Cancelar</a>
            </div>
